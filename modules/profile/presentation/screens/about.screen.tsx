import { useFadeHeaderScroll } from '@/shared/presentation/components/fade-header-scroll-view';
  ...
  useEffect(() => {
    ...
    orbY.value = withDelay(
      ...
      withRepeat(
        withSequence(
          ...
          withTiming(2, {
            duration: orbDuration * 0.8,
            easing: Easing.inOut(Easing.ease),
          }),
          withTiming(0, {
            duration: orbDuration * 0.6,
            easing: Easing.inOut(Easing.ease),
          }),
        ),
        -1,
    ...
    orbX.value = withDelay(
      ...
      withRepeat(
        withSequence(
          withTiming(5, {
            duration: orbDuration * 1.3,
            easing: Easing.inOut(Easing.ease),
          }),
          withTiming(-3, {
            duration: orbDuration * 1.1,
            easing: Easing.inOut(Easing.ease),
          }),
          withTiming(0, {
            duration: orbDuration,
  ...
  return (
    <Animated.View style={[styles.featureCardWrapper, cardStyle]}>
      ...
      >
        ...
        <Text style={[styles.featureTitle, { color: colors.textOnSurface }]}>
          {title}
        </Text>
...
export default function AboutScreen() {
  ...
  // Parallax + fade del hero al bajar (reutilizable).
  const { scrollHandler, headerStyle: heroContentStyle } = useFadeHeaderScroll();
  ...
  const features = [
    {
      ...
      description:
        'Crea listas con precios en Bs y ve el total en USD al instante',
    },
    {
      Icon: DollarSign,
      ...
      <Animated.View style={descStyle}>
        ...
        >
          <Text style={[styles.descText, { color: colors.textOnSurface }]}>
            ...
            compras en un país donde los precios cambian constantemente.
            Convierte entre moneda local y dólares al instante, organiza tus
            listas de supermercado y mantén tus deudas en orden — todo desde un
            solo lugar.
          </Text>
        </View>
      </Animated.View>

...
import { ListInitializationBanner } from './ListInitializationBanner';

type ShoppingListsAddPanelProps = {
...
export const ShoppingListsAddPanel = React.memo(function ShoppingListsAddPanel({
  canInteractWithList,
  isInitializingList,
  listInitError,
